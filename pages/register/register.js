...
var get_service_private_content = 'https://pipilong.pet:7449/photography/get_service_private_content'; //获取应用实例
...
\n \
  ...
  save(e) {
    ...
    console.log('密码: ' + this.data.pwd); // 展示服务条例与隐私协议
    ...
    tt.request({
      ...
      success: function (res) {
        ...
        if (res.data.status == '200') {
          ...
          tt.setStorageSync("phone", that.data.phone); // success
