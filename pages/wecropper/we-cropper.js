...
(function (global, factory) {
  ...
  function prepare() {
    var self = this; // v1.4.0 版本中将不再自动绑定we-cropper实例
    ...
    self.createCtx = function () {
      ...
      if (id) {
        self.ctx = self.ctx || tt.createCanvasContext(id);
        self.targetCtx = self.targetCtx || tt.createCanvasContext(targetId);
      } else {
  ...
  var getImageInfo = wxPromise(tt.getImageInfo);
  var canvasToTempFilePath = wxPromise(tt.canvasToTempFilePath);
  var base64 = createCommonjsModule(function (module, exports) {
    ...
    (function (root) {
      ...
      var freeModule = 'object' == 'object' && module && module.exports == freeExports && module; // Detect free variable `global`, from Node.js or Browserified code, and use
      // it as `root`.
