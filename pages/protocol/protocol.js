...
2.【本服务内容】本协议服务于”相比“小程序，仅用于此小程序。本协议内容同时包括电巴克可能不断发布的关于本服务的相关协议、业务规则等内容。内容一经正式发布，即为本服务不可分割的组成部分。 \n \
 \n \
三、关于本服务 \n \
...
2.【服务开通】您应该通过电巴克指定的支付方式、今后电巴克指定方式在依约支付一定费用后开通本服务。本服务开通之后，不可进行转让。您理解并同意：对于通过手机短信方式开通本服务的用户，为了保护手机用户的帐户安全、保障用户权益，电巴克有权对手机用户的交易及使用行为进行独立判断。如果电巴克根据一般的常识判断认为可能存在风险，您将无法完成重复开通的操作，对于前述由于电巴克采取的相关措施导致您可能无法开通本服务或可能给您造成损失的，您同意自行承担相关责任和损失。 \n \
...
上海电巴克宠物服务有限公司   \n\n \
      ...
      this.setData({
        content: '隐私保护协议 \n \
                \n \
               一、概述 \n \
               本协议适用于所有使用“【相比】”小程序（以下简称本软件）所提供的服务等相关事宜所订立的契约，请您仔细阅读本注册协议，您点击“我已阅读并同意《宠物摄影服务协议》“，本协议即构成对双方有约束力的法律文件。 \n \
               ...
               3.如您已阅读并同意《宠物摄影服务协议》成功注册后，即可以享受【相比】宠物摄影服务。通过参与【相比】小程序定期及不定期举行的活动，都将获得相应的积分奖励。您的参加的活动越多，达成目标越多，获得的积分值也将更多。积分不仅可以兑换【相比】礼品，还可以享受更多的会员服务。 \n \
                \n \
               三、隐私保护 \n \
